...
public class TesterClient {
	public static void main(String[] args){
	    ...
	    String shareExample = "{ \"command\": \"SHARE\", \"secret\":\"asddf\", \"resource\": { \"name\": \"EZShare JAR\", \"tags\": [ \"jar\" ], \"description\": \"The jar file for EZShare. Use with caution.\", \"uri\":\"d://temp.txt\", \"channel\": \"\", \"owner\": \"aaron010\", \"ezserver\": null } }";
	    ...
	    Client.doSendSecure(serverHostname,serverPort,query,null,Log.debug);
	}
