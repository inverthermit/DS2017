...
/**
 * This class is implemented to get command and arguments from the command line of client 
...
public class ClientCommandLine {
     ...
     * if the context of the command line has invalid command or invalid arguments. The method
     * will return null. 
     * 
	...
	/**
     * The function of this method is transmit remove command and its 
     * parameters into JSON string and check whether the parameters are invalid
     * or not 
     * 
     * @return a JSON string
	...
	/**
     * The function of this method is transmit query command and its 
     * parameters into JSON string and check whether the parameters are invalid
     * or not 
     * 
     * @return a JSON string
	...
	/**
     * The function of this method is transmit fetch command and its 
     * parameters into JSON string and check whether the parameters are invalid
     * or not 
     * 
     * @return a JSON string
	...
	/**
     * The function of this method is transmit share command and its 
     * parameters into JSON string and check whether the parameters are invalid
     * or not 
     * 
     * @return a JSON string
	...
	/**
     * The function of this method is to get the resource parameters from the command line and
     * check the parameters are valid or not and check whether the parameters are enough for
     * the command.
     * 
	...
	/**
	 * The function of this method is to get port number from the command line. If
	 * command line does not has the port number then it will return 0.
	 */
	 ...
	 * @param arg  the parameters array from the command line
	 * @param command the parameters array that this command must havd
