...
public class ServerCommandLine {
	public static void main(String[] args) {
        ...
        Option connectionintervallimit = Option.builder("connectionintervallimit")
        		.hasArg()
        		.desc("connection interval limit in seconds")
        		.build();
        opt.addOption(connectionintervallimit);
        Option exchangeinterval = Option.builder("exchangeinterval")
        		.hasArg()
        		.desc("exchange interval in seconds")
        		.build();
        ...
        if (commandLine.hasOption("advertisedhostname")) {
        	String hostName = commandLine.getOptionValue("advertisedhostname");
        ...
        if (commandLine.hasOption("connectionintervallimit")) {
        	String intervalLimit = commandLine.getOptionValue("connectionintervallimit");
        	ServerModel server = new ServerModel();
       ...
       // if command line has -exchangeinterval 
        if (commandLine.hasOption("exchangeinterval")) {
        	String exchangeInterval = commandLine.getOptionValue("exchangeinterval");
        	ServerModel server = new ServerModel();
